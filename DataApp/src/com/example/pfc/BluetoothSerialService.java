...
public class BluetoothSerialService {
	...
	/**
	 * Constructor. Prepares a new BluetoothSerialService session.
	 * 
	 * @param context
	...
	/**
	 * Start the Serial service.Called by the Activity onResume()
	 */
		...
		public void run() {
			...
			while (true) {
				try {
					...
					mProcessData.write(buffer, bytes);
